...
class SessionHistory:
    ...
    def summary(self):
        ...
        short = [
            s
            for s in completed
            if s.get("type") == "Short Break"
        ]

        long = [
            s
            for s in completed
            if s.get("type") == "Long Break"
        ]
    ...
    def analytics(
        ...
        #     count toward the successful side.
        #
        # Skipped Work sessions:
        ...
        return {
            ...
            "today_work_attempted":
                attempted_work,

            # Kept for compatibility with
            # any other part of the application
            # that may use these values.
            "total_work":
                total_work,
